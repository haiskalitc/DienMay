...
namespace DienMay.NumbericTextBox
{
  public class CurrencyTextBox : TextBox
    {
        ...
        public long Number
        {
            get
            {
                return (long)GetValue(NumberProperty);
            }
            set
            {
        ...
        public static readonly DependencyProperty StringFormatProperty = DependencyProperty.Register(
            "StringFormat",
            typeof(string),
            typeof(CurrencyTextBox), new FrameworkPropertyMetadata("0,###", StringFormatPropertyChanged));
        //,new FrameworkPropertyMetadata("0,###", StringFormatPropertyChanged)
